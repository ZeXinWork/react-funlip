  ...
  render() {
    ...
    const onFinish = (values) => {
      ...
      if (!setPassword || setPassword == '') {
        this.setState(
          { passwordErrorInfo: '请输入主密码！', warnIng: 'block' },
          () => {
            setTimeout(() => {
              _this.setState({
                warnIng: 'none',
      ...
      } else if (!ConfirmPsw || setPassword == '') {
        this.setState(
          {
            passwordErrorInfo: '请再次确认主密码！',
            warnIng: 'block',
          },
          () => {
            setTimeout(() => {
      ...
      <div className="set-wrapper">
        <div className="smile-message" style={{ display: this.state.warnIng }}>
          <img
            src={iconWarning}
            className="icon-fail"
            alt="setMainPsw-iconWarning"
          />
          <div className="smile-text">{this.state.passwordErrorInfo}</div>
        </div>
        <img
          src={iconArrow}
          alt="iconArrow"
